package com.junhyeong.portfolio.admin.context.dashboard.controlloer

import com.junhyeong.portfolio.admin.context.dashboard.data.VisitorsDTO
import com.junhyeong.portfolio.admin.context.dashboard.service.AdminDashboardService
...
class AdminDashboardViewController(
    ...
    fun index(model: Model): String{
        ...
        val today = adminDashboardService.countVisitorsTotal()
