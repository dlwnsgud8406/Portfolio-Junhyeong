package com.junhyeong.portfolio.domain

import com.junhyeong.portfolio.domain.constant.SkillType
import com.junhyeong.portfolio.domain.entity.*
import com.junhyeong.portfolio.domain.repository.*
    ...
    fun initializeData(){
        ...
        val achievements = mutableListOf<Achievement>(
            Achievement(
                ...
                description = "고양이 쇼핑몰 검색 서비스의 아키텍처, 데이터 모델링, API 개발 역할 수행", host = "캣카오",
        ...
        project2.addDetails(
            mutableListOf(
                ProjectDetail(content = "PIL(Pillow) 활용하여 이미지 분석 기능 개발", url = null,
                    isActive = true),
                ProjectDetail(content = "알림 발송을 비동기 처리하여 이미지 분석 - 알림 발송 기능간 의존도 감소", url = null,
                    isActive = true),
