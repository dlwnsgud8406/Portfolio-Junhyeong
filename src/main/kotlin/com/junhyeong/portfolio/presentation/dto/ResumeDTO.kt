...
class ResumeDTO(
    ...
    var experiences: List<ExperienceDTO> = experiences.map {experience ->  ExperienceDTO(
    ...
    var achievements: List<AchievementDTO> = achievements.map {achievement -> AchievementDTO(
